...
@XmlRootElement(name = "AgregarIphoneRequest")
public class AgregarIphoneRequest {

    @XmlElement(required = true)
    protected List<AgregarIphoneRequest.Iphone> iphone;
     ...
     * {@link AgregarIphoneRequest.Iphone }
     * 
     * 
     */
    public List<AgregarIphoneRequest.Iphone> getIphone() {
        if (iphone == null) {
            iphone = new ArrayList<AgregarIphoneRequest.Iphone>();
        }
        return this.iphone;
    }
